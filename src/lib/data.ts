...
export const FACTIONS: Record<string, Detachment[]> = {
  "Space Marines": [
    { n: "Vengeful Hosts", d: "Take and Hold", dp: 1, new: true },
    { n: "Fulguris Task Force", d: "Reconnaissance", dp: 1, new: true },
    { n: "Librarius Conclave", d: "Reconnaissance", dp: 1, new: true },
    { n: "Subversion Assets", d: "Disruption", dp: 1, new: true },
    { n: "1st Company Task Force", d: "Purge the Foe", dp: 2 },
    ...
    { n: "Emperor's Shield", d: "Purge the Foe", dp: 2 },
    { n: "Firestorm Assault Force", d: "Priority Assets", dp: 2 },
    { n: "Forgefather's Seekers", d: "Priority Assets", dp: 2 },
    { n: "Gladius Task Force", d: "Priority Assets", dp: 3 },
    { n: "Hammer of Avernii", d: "Purge the Foe", dp: 2 },
    { n: "Headhunter Task Force", d: "Priority Assets", dp: 2 },
    { n: "Ironstorm Spearhead", d: "Take and Hold", dp: 2 },
  ...
  "Dark Angels": [
    ...
    { n: "Interrogation Conclave", d: "Take and Hold", dp: 1, new: true },
  ...
  "Space Wolves": [
    { n: "Champions of Fenris", d: "Priority Assets", dp: 1, new: true },
  ...
  "Black Templars": [
    ...
    { n: "The Living Miracle", d: "Disruption", dp: 1, new: true },
    { n: "Wrathful Procession", d: "Take and Hold", dp: 1, new: true },
    { n: "Companions of Vehemence", d: "Purge the Foe", dp: 2 },
    { n: "Godhammer Assault Force", d: "Purge the Foe", dp: 2 },
    { n: "Vindication Task Force", d: "Priority Assets", dp: 2 },
  ],
  "Grey Knights": [
    { n: "Argent Assault", d: "Priority Assets", dp: 1, new: true },
    { n: "Fires of Purgation", d: "Disruption", dp: 1, new: true },
    { n: "Immaterial Interdiction", d: "Reconnaissance", dp: 1, new: true },
    ...
    { n: "Warpbane Task Force", d: "Take and Hold", dp: 3 },
  ],
  Deathwatch: [
    { n: "Black Spear Task Force", d: "Purge the Foe", dp: 3 },
  ],
  "Astra Militarum": [
    ...
    { n: "Combined Arms", d: "Take and Hold", dp: 2 },
    { n: "Grizzled Company", d: "Priority Assets", dp: 3 },
    { n: "Hammer of the Emperor", d: "Purge the Foe", dp: 2 },
    { n: "Mechanised Assault", d: "Reconnaissance", dp: 2 },
    { n: "Recon Element", d: "Reconnaissance", dp: 2 },
  ...
  "Adepta Sororitas": [
    ...
    { n: "Sanctified Orators", d: "Disruption", dp: 1, new: true },
    { n: "Army of Faith", d: "Take and Hold", dp: 2 },
    { n: "Bringers of Flame", d: "Priority Assets", dp: 2 },
    { n: "Champions of Faith", d: "Disruption", dp: 2 },
    { n: "Hallowed Martyrs", d: "Priority Assets", dp: 3 },
    { n: "Penitent Host", d: "Purge the Foe", dp: 2 },
  ],
  "Adeptus Mechanicus": [
  ...
  "Adeptus Custodes": [
    { n: "Might of the Moritoi", d: "Take and Hold", dp: 1, new: true },
    { n: "Silent Hunters", d: "Reconnaissance", dp: 1, new: true },
    { n: "Tharanatoi Hammerblow", d: "Disruption", dp: 1, new: true },
    { n: "Auric Champions", d: "Priority Assets", dp: 2 },
    { n: "Lions of the Emperor", d: "Take and Hold", dp: 3 },
  ...
  "Imperial Agents": [
    { n: "Imperialis Fleet", d: "Reconnaissance", dp: 2 },
    { n: "Ordo Hereticus, Purgation Force", d: "Take and Hold", dp: 2 },
    { n: "Ordo Malleus, Daemon Hunters", d: "Priority Assets", dp: 2 },
    { n: "Ordo Xenos, Alien Hunters", d: "Purge the Foe", dp: 2 },
    { n: "Veiled Blade Elimination Force", d: "Disruption", dp: 1 },
  ],
  "Chaos Space Marines": [
    { n: "Cabal of Chaos", d: "Disruption", dp: 1, new: true },
    { n: "Devotees of Destruction", d: "Priority Assets", dp: 1, new: true },
    { n: "Murdertalon Raiders", d: "Reconnaissance", dp: 1, new: true },
    ...
    { n: "Huron's Marauders", d: "Purge the Foe", dp: 3 },
    ...
    { n: "Soulforged Warpack", d: "Take and Hold", dp: 2 },
    { n: "Veterans of the Long War", d: "Take and Hold", dp: 2 },
    { n: "Warpstrike Champions", d: "Disruption", dp: 2 },
  ],
  "World Eaters": [
    { n: "Butchers of Khorne", d: "Take and Hold", dp: 1, new: true },
    { n: "Brazen Engines", d: "Disruption", dp: 1, new: true },
  ...
  "Emperor's Children": [
    ...
    { n: "Frenzied Host", d: "Reconnaissance", dp: 1, new: true },
    { n: "Spectacle of Slaughter", d: "Disruption", dp: 1, new: true },
    { n: "Carnival of Excess", d: "Disruption", dp: 2 },
    { n: "Coterie of the Conceited", d: "Priority Assets", dp: 3 },
  ...
  "Death Guard": [
    ...
    { n: "Contagion Engines", d: "Reconnaissance", dp: 1, new: true },
  ...
  "Thousand Sons": [
    { n: "Ritual of Regeneration", d: "Take and Hold", dp: 1, new: true },
    { n: "Sekhetar Cohort", d: "Disruption", dp: 1, new: true },
    ...
    { n: "Hexwarp Thrallband", d: "Take and Hold", dp: 3 },
    { n: "Rubricae Phalanx", d: "Take and Hold", dp: 3 },
    { n: "Warpforged Cabal", d: "Priority Assets", dp: 2 },
    { n: "Warpmeld Pact", d: "Purge the Foe", dp: 2 },
  ],
  "Chaos Knights": [
    { n: "Bastions of Tyranny", d: "Priority Assets", dp: 1, new: true },
    ...
    { n: "Infernal Lance", d: "Priority Assets", dp: 3 },
    { n: "Lords of Dread", d: "Take and Hold", dp: 2 },
    { n: "Traitoris Lance", d: "Purge the Foe", dp: 2 },
  ],
  "Chaos Daemons": [
    { n: "Cavalcade of Chaos", d: "Disruption", dp: 1, new: true },
    { n: "Lords of the Warp", d: "Take and Hold", dp: 1, new: true },
    { n: "Warptide", d: "Reconnaissance", dp: 1, new: true },
    { n: "Blood Legion", d: "Purge the Foe", dp: 2 },
    { n: "Daemonic Incursion", d: "Take and Hold", dp: 3 },
  ...
  Orks: [
    { n: "Brute Bosses", d: "Purge the Foe", dp: 1, new: true },
    { n: "Flyboyz", d: "Reconnaissance", dp: 1, new: true },
    { n: "Madcap Meks", d: "Disruption", dp: 1, new: true },
    { n: "Runt Swarm", d: "Priority Assets", dp: 1, new: true },
    { n: "Shoota Boyz", d: "Purge the Foe", dp: 1, new: true },
    { n: "Wreckas", d: "Priority Assets", dp: 1, new: true },
    { n: "Wurrband", d: "Disruption", dp: 1, new: true },
    { n: "Blitz Brigade", d: "Take and Hold", dp: 1 },
    { n: "Bully Boyz", d: "Purge the Foe", dp: 1 },
    { n: "Da Big Hunt", d: "Purge the Foe", dp: 1 },
    { n: "Dread Mob", d: "Purge the Foe", dp: 1 },
    { n: "Green Tide", d: "Take and Hold", dp: 1 },
    { n: "Kult of Speed", d: "Reconnaissance", dp: 1 },
    { n: "Taktikal Brigade", d: "Take and Hold", dp: 1 },
  ...
  Aeldari: [
    ...
    { n: "Warhost", d: "Reconnaissance", dp: 3 },
    { n: "Windrider Host", d: "Disruption", dp: 2 },
  ],
  Drukhari: [
    { n: "Exhibition of Slaughter", d: "Reconnaissance", dp: 1, new: true },
    { n: "Kabalite Agonysts", d: "Disruption", dp: 1, new: true },
    { n: "Tools of Torment", d: "Take and Hold", dp: 1, new: true },
    { n: "Covenite Coterie", d: "Take and Hold", dp: 2 },
  ...
  "Genestealer Cults": [
    { n: "Heroes of the Uprising", d: "Disruption", dp: 1, new: true },
    { n: "Purestrain Broodswarm", d: "Priority Assets", dp: 1, new: true },
    { n: "Xenocult Masses", d: "Reconnaissance", dp: 1, new: true },
    { n: "Biosanctic Broodsurge", d: "Take and Hold", dp: 2 },
    { n: "Brood Brothers Auxilia", d: "Take and Hold", dp: 2 },
  ...
  Necrons: [
    ...
    { n: "Pantheon of Woe", d: "Disruption", dp: 2 },
  ...
  "Leagues of Votann": [
    ...
    { n: "Dêlve Assault Shift", d: "Purge the Foe", dp: 2 },
    { n: "Hearthband", d: "Priority Assets", dp: 3 },
    { n: "Hearthfyre Arsenal", d: "Priority Assets", dp: 2 },
    { n: "Mercenary Oathband", d: "Take and Hold", dp: 2 },
    { n: "Needgaârd Oathband", d: "Purge the Foe", dp: 2 },
    { n: "Persecution Prospect", d: "Disruption", dp: 2 },
  ],
  "T'au Empire": [
    { n: "Advanced Acquisition Cadre", d: "Reconnaissance", dp: 1, new: true },
    { n: "Auxiliary Cadre", d: "Disruption", dp: 1, new: true },
    { n: "Experimental Prototype Cadre", d: "Priority Assets", dp: 1, new: true },
    { n: "Kauyon", d: "Reconnaissance", dp: 2 },
    { n: "Kroot Hunting Pack", d: "Take and Hold", dp: 2 },
    { n: "Mont'ka", d: "Priority Assets", dp: 3 },
    { n: "Retaliation Cadre", d: "Purge the Foe", dp: 3 },
  ],
};
